...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BillSummaryCell *cell = [tableView dequeueReusableCellWithIdentifier:@"BillSummaryCell"];
    Bill* billObject=[self.bills objectAtIndex:indexPath.row];
    [cell.billNameLabel setText:billObject.billName];
    [cell.billBalanceLabel setText:[NSString stringWithFormat:@"Balance: %f",billObject.billBalance]];
    return cell;
}
